...
search.addEventListener("click", (e)=>{
    ...
    .then(
        data =>{
           ...
           data.works.forEach(element => {
            let tagLi = document.createElement("li") //creo il tag li per ogni elemento
            let listLink= document.createElement("a") //creo il tag a
            listLink.href="#" //attibuto href
            ...
            authorsPar.textContent= "Authors: " +element.authors.map(author => author.name).join(", ")
    ...
    .catch((e)=>{
        ...
        document.querySelector(".wrapper").innerHTML="Errore nel recupero dei dati"
    })
